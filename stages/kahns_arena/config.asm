...
constant VRAM_BG1_MAP   = $6000 // 64x64 => $2000 bytes
...
// ============================================================================
constant BG1_BAND0_LINES = 99
constant BG1_BAND1_LINES = 52
constant BG1_BAND2_LINES = 24
constant BG1_BAND3_LINES = 26
constant BG1_BAND4_LINES = 35

constant BG2_BAND0_LINES = 39
constant BG2_BAND1_LINES = 69
constant BG2_BAND2_LINES = 68
constant BG2_BAND3_LINES = 9
constant BG2_BAND4_LINES = 39
...
// - $FF ≈ ~1.0 (255/256)
// ============================================================================
constant BG1_RATIO_B0 = $50
constant BG1_RATIO_B1 = $58
constant BG1_RATIO_B2 = $68
constant BG1_RATIO_B3 = $B0
constant BG1_RATIO_B4 = $D0

constant BG2_RATIO_B0 = $7F
constant BG2_RATIO_B1 = $8D
constant BG2_RATIO_B2 = $8D
constant BG2_RATIO_B3 = $8D
...
// Stage offsets (word)
// ============================================================================
constant STAGE_BG1_X_OFFSET = $0060
...
constant STAGE_CC0_OFF0 = 15
constant STAGE_CC0_OFF1 = 14
constant STAGE_CC0_OFF2 = 13
constant STAGE_CC0_OFF3 = 12
...
constant STAGE_CC1_SUBPAL = 5
constant STAGE_CC1_LEN = 4
...
constant STAGE_CC1_OFF0 = 15
constant STAGE_CC1_OFF1 = 14
constant STAGE_CC1_OFF2 = 13
constant STAGE_CC1_OFF3 = 12
...
constant STAGE_CC2_SUBPAL = 3
constant STAGE_CC2_LEN    = 3
constant STAGE_CC2_DIR    = 0
constant STAGE_CC2_DELAY  = 10
...
constant STAGE_CC2_OFF0 = 7
constant STAGE_CC2_OFF1 = 5
...
//
// Regra de layout atual (cenarios padrao deste projeto):
...
constant STAGE_TSWAP_JOB0_W = 9
constant STAGE_TSWAP_JOB0_H = 5
...
constant STAGE_TSWAP_JOB0_NUM_FRAMES = 6
constant STAGE_TSWAP_JOB0_GAP = 30
...
constant STAGE_TSWAP_JOB1_W = 10
constant STAGE_TSWAP_JOB1_H = 6
constant STAGE_TSWAP_JOB1_PAL = 6
constant STAGE_TSWAP_JOB1_PRIO = 1
...
constant STAGE_TSWAP_JOB1_GAP = 30
...
constant STAGE_TSWAP_JOB2_DELAY = 4
constant STAGE_TSWAP_JOB2_NUM_FRAMES = 3
