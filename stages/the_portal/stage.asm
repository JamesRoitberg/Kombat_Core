...
BG1_Palette:
  insert "assets/portal-bg1.pal"
BG1_Palette_End:

BG1_Tiles:
  insert "assets/portal-bg1.chr"
BG1_Tiles_End:
...
BG2_Palette:
  insert "assets/portal-bg2.pal"
BG2_Palette_End:

BG2_Tiles:
  insert "assets/portal-bg2.chr"
BG2_Tiles_End:

BG2_Map:
  insert "assets/portal-bg2.map"
BG2_Map_End:

// -----------------------------------------------------------------------------
// Nota de TileSwap deste stage:
// - Declare apenas os jobs ativos e mantenha OFF os nao usados.
// - Exemplo comum: JOB0 e JOB1 ativos com animacoes independentes.
// - Mantenha jobs nao usados em OFF no config.
// - Evite manter blocos de assets de jobs OFF sem necessidade.
//
...
TSWAP_JOB0_FR0:
  insert "assets/flying-s-01.chr"
TSWAP_JOB0_FR0_End:

TSWAP_JOB0_FR1:
  insert "assets/flying-s-02.chr"
TSWAP_JOB0_FR1_End:

TSWAP_JOB0_FR2:
  insert "assets/flying-s-03.chr"
TSWAP_JOB0_FR2_End:

TSWAP_JOB0_FR3:
  insert "assets/flying-s-04.chr"
TSWAP_JOB0_FR3_End:

TSWAP_JOB0_FR4:
  insert "assets/flying-s-05.chr"
TSWAP_JOB0_FR4_End:

TSWAP_JOB0_FR5:
  insert "assets/flying-s-06.chr"
TSWAP_JOB0_FR5_End:

TSWAP_JOB0_FR6:
  insert "assets/flying-s-07.chr"
TSWAP_JOB0_FR6_End:
...
TSWAP_JOB1_FR0:
  insert "assets/lightining-01.chr"
TSWAP_JOB1_FR0_End:

TSWAP_JOB1_FR1:
  insert "assets/lightining-02.chr"
TSWAP_JOB1_FR1_End:

TSWAP_JOB1_FR2:
  insert "assets/lightining-03.chr"
TSWAP_JOB1_FR2_End:

TSWAP_JOB1_FR3:
  insert "assets/lightining-04.chr"
TSWAP_JOB1_FR3_End:

TSWAP_JOB1_FR4:
  insert "assets/lightining-05.chr"
TSWAP_JOB1_FR4_End:

TSWAP_JOB1_FR5:
  insert "assets/lightining-06.chr"
TSWAP_JOB1_FR5_End:

TSWAP_JOB1_FR6:
  insert "assets/lightining-07.chr"
TSWAP_JOB1_FR6_End:

TSWAP_JOB1_FR7:
  insert "assets/lightining-08.chr"
TSWAP_JOB1_FR7_End:
