...
BG1_Palette:
  insert "assets/tower1.pal"
BG1_Palette_End:

BG1_Tiles:
  insert "assets/tower1.chr"
BG1_Tiles_End:
...
BG2_Palette:
  insert "assets/tower2.pal"
BG2_Palette_End:

BG2_Tiles:
  insert "assets/tower2.chr"
BG2_Tiles_End:

BG2_Map:
  insert "assets/tower2.map"
BG2_Map_End:
...
//
// Chr de Animações JOB0 — bank limpo
// -----------------------------------------------------------------------------
seek($0F8000)
