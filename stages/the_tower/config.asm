...
// ============================================================================
constant BG1_BAND0_LINES = 87
constant BG1_BAND1_LINES = 72
constant BG1_BAND2_LINES = 8
constant BG1_BAND3_LINES = 34
constant BG1_BAND4_LINES = 23

constant BG2_BAND0_LINES = 84
constant BG2_BAND1_LINES = 84
constant BG2_BAND2_LINES = 28
constant BG2_BAND3_LINES = 27
...
// - $FF ≈ ~1.0 (255/256)
// ============================================================================
constant BG1_RATIO_B0 = $80
constant BG1_RATIO_B1 = $D0
constant BG1_RATIO_B2 = $EA
constant BG1_RATIO_B3 = $F0
constant BG1_RATIO_B4 = $FF

constant BG2_RATIO_B0 = $EA
constant BG2_RATIO_B1 = $EA
constant BG2_RATIO_B2 = $FF
constant BG2_RATIO_B3 = $FF
...
constant STAGE_SCROLL_TRACK1_TARGET_BG = 1
constant STAGE_SCROLL_TRACK1_BAND      = 1
constant STAGE_SCROLL_TRACK1_DIR       = 1
constant STAGE_SCROLL_TRACK1_SPEED_INT  = 2
...
constant STAGE_CC0_OFF1 = 3
constant STAGE_CC0_OFF2 = 4
constant STAGE_CC0_OFF3 = 5
...
constant STAGE_TSWAP_JOB0_TARGET_BG = 2       // 1=BG1, 2=BG2

// Tamanho do retângulo em tiles (8x8):
// Ex.: 5x4 => 40x32 px
constant STAGE_TSWAP_JOB0_W = 5
constant STAGE_TSWAP_JOB0_H = 11
...
constant STAGE_TSWAP_JOB2_TARGET_BG = 2        // 1=BG1, 2=BG2

constant STAGE_TSWAP_JOB2_W = 5
constant STAGE_TSWAP_JOB2_H = 11

constant STAGE_TSWAP_JOB2_PAL  = 7
constant STAGE_TSWAP_JOB2_PRIO = 1
constant STAGE_TSWAP_JOB2_PAL_BITS = ((STAGE_TSWAP_JOB2_PAL << 10) | (STAGE_TSWAP_JOB2_PRIO << 13))

constant STAGE_TSWAP_JOB2_DELAY = 7
