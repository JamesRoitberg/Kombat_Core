...
// ============================================================================
constant BG1_BAND0_LINES = 128
constant BG1_BAND1_LINES = 16
constant BG1_BAND2_LINES = 30
constant BG1_BAND3_LINES = 26
constant BG1_BAND4_LINES = 24
...
constant BG1_RATIO_B1 = $50
constant BG1_RATIO_B2 = $B0
constant BG1_RATIO_B3 = $E9
constant BG1_RATIO_B4 = $FA

constant BG2_RATIO_B0 = $E9
constant BG2_RATIO_B1 = $E9
constant BG2_RATIO_B2 = $E9
constant BG2_RATIO_B3 = $E9
constant BG2_RATIO_B4 = $B0


// ============================================================================
// Stage offsets (word)
// ============================================================================
constant STAGE_BG1_X_OFFSET = $0008
constant STAGE_BG1_Y_OFFSET = $0000
constant STAGE_BG2_X_OFFSET = $FFB0
...
// Ex.: 5x4 => 40x32 px
constant STAGE_TSWAP_JOB0_W = 1
constant STAGE_TSWAP_JOB0_H = 8
