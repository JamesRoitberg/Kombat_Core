...
// Stage feature flags
// ============================================================================
constant STAGE_ENABLE_GRADIENT   = 0
...
// ============================================================================
constant BG1_BAND0_LINES = 80
constant BG1_BAND1_LINES = 64
constant BG1_BAND2_LINES = 40
constant BG1_BAND3_LINES = 39
constant BG1_BAND4_LINES = 1

constant BG2_BAND0_LINES = 80
constant BG2_BAND1_LINES = 64
constant BG2_BAND2_LINES = 40
constant BG2_BAND3_LINES = 39
...
// - $FF ~= ~1.0 (255/256)
// ============================================================================
constant BG1_RATIO_B0 = $60
constant BG1_RATIO_B1 = $70
constant BG1_RATIO_B2 = $80
constant BG1_RATIO_B3 = $A0
constant BG1_RATIO_B4 = $FF

constant BG2_RATIO_B0 = $70
constant BG2_RATIO_B1 = $80
constant BG2_RATIO_B2 = $90
constant BG2_RATIO_B3 = $B0
...
constant STAGE_SCROLL_TRACK0_SPEED_FRAC = 0
...
constant STAGE_SCROLL_TRACK1_SPEED_FRAC = 0
...
constant STAGE_SCROLL_TRACK2_SPEED_FRAC = 0
...
// JOB0
constant STAGE_TSWAP_JOB0_ENABLE = 0
constant STAGE_TSWAP_JOB0_TARGET_BG = 2
constant STAGE_TSWAP_JOB0_W = 1
constant STAGE_TSWAP_JOB0_H = 1
constant STAGE_TSWAP_JOB0_PAL = 0
...
constant STAGE_TSWAP_JOB0_NUM_FRAMES = 1
...
constant STAGE_TSWAP_JOB1_NUM_FRAMES = 1
